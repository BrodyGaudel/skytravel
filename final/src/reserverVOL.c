...
{ 
    ...
    f=fopen("/home/malekbouslah/Desktop/final/src/catalogue_vola.txt","r");
    if(f!=NULL)
    {
...
FILE *f=fopen("/home/malekbouslah/Desktop/final/src/catalogue_vola.txt","r");
VOL v;
...
f=fopen("/home/malekbouslah/Desktop/final/src/reservation.txt","a+");//ouvertur du fichier en mode lecture
if(f!=NULL) 
{
...
FILE* f=fopen("/home/malekbouslah/Desktop/final/src/catalogue_vola.txt","r");
FILE* f1=fopen("/home/malekbouslah/Desktop/final/src/tempo.txt","a+");
...
fclose(f1);
fclose(f);
rename("/home/malekbouslah/Desktop/final/src/tempo.txt","/home/malekbouslah/Desktop/final/src/catalogue_vola.txt");
}
...
fclose(f1);
fclose(f);
rename("/home/malekbouslah/Desktop/final/src/tempo.txt","/home/malekbouslah/Desktop/final/src/reservation.txt");

char num[50],id[50],depart[50],destination[50],compagnie[50],date_aller[50],date_retour[50],classe[50];
int nb_voy;
float prix;
FILE* f2=fopen("/home/malekbouslah/Desktop/final/src/volreserver.txt","r");
FILE* f3=fopen("/home/malekbouslah/Desktop/final/src/tempo1.txt","a+");
...
fclose(f3);
fclose(f2);
rename("/home/malekbouslah/Desktop/final/src/tempo1.txt","/home/malekbouslah/Desktop/final/src/volreserver.txt");
