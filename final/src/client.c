...
if(store==NULL)
{
	...
	{ 
	f=fopen("/home/malekbouslah/Desktop/final/src/client.txt","a+");
...
void supprimer_client (char supp[30] )
{
FILE *f;
FILE *f1;
personne p;
f=fopen("/home/malekbouslah/Desktop/final/src/client.txt","r");
f1=fopen("/home/malekbouslah/Desktop/final/src/file.txt","a+");
...
fclose(f);
fclose(f1);
remove("/home/malekbouslah/Desktop/final/src/client.txt");
rename("/home/malekbouslah/Desktop/final/src/file.txt","/home/malekbouslah/Desktop/final/src/client.txt");
//FILE *f2=fopen("/home/malekbouslah/Desktop/final/src/users.txt"
}
