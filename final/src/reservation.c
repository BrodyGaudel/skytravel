...
store=gtk_list_store_new(COLUMNS,G_TYPE_STRING,G_TYPE_STRING,G_TYPE_STRING,G_TYPE_STRING,G_TYPE_FLOAT);
	...
	f=fopen("/home/malekbouslah/Desktop/final/src/reservation.txt","r");
	...
	{ 
	f=fopen("/home/malekbouslah/Desktop/final/src/reservation.txt","a+");
		while(fscanf(f,"%s %s %s %s %s %s %f  \n",r.num_res,r.identifiant,r.date_reservation.jour,r.date_reservation.mois,r.date_reservation.annee,r.type,&r.devis)!=EOF)
...
//affichage reservation agent

void afficher_resagent(GtkWidget *liste)
{
GtkCellRenderer *renderer;
GtkTreeViewColumn *column;
GtkTreeIter iter;
...
while (fscanf(f,"%s %s %s %s %s %s %f  \n",r.num_res,r.identifiant,r.date_reservation.jour,r.date_reservation.mois,r.date_reservation.annee,r.type,&r.devis)!=EOF)
        ...
        {
	f2=fopen("/home/malekbouslah/Desktop/final/src/testres.txt", "a");
		if (f2==NULL)
		{
		return;
		}
	...
	fclose(f);
remove("/home/malekbouslah/Desktop/final/src/reservation.txt");
rename("/home/malekbouslah/Desktop/final/src/testres.txt","/home/malekbouslah/Desktop/final/src/reservation.txt");
...
int nb_voy;
float prix;
f1=fopen("/home/malekbouslah/Desktop/final/src/volreserver.txt","r");
...
while (fscanf(f1,"%s %s %s %s %s %s %s %s %d %f\n",num,id,depart,destination,compagnie,date_aller,date_retour,classe,&nb_voy,&prix)!=EOF)
        ...
        {
	f3=fopen("/home/malekbouslah/Desktop/final/src/testvol.txt", "a");
		if (f3==NULL)
		{
		return;
		}
	...
	fclose(f1);
remove("/home/malekbouslah/Desktop/final/src/volreserver.txt");
rename("/home/malekbouslah/Desktop/final/src/testvol.txt","/home/malekbouslah/Desktop/final/src/volreserver.txt");
