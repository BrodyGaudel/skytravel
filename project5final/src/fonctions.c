...
void ajouter_hotel(hotel p)
{
 ...
 FILE *f;
 f=fopen("/home/amir07/Projects/project5/src/hotel.txt","a+");
 if(f!=NULL)
 {
...
hotel p;
f=fopen("/home/amir07/Projects/project5/src/hotel.txt","r");
f1=fopen("/home/amir07/Projects/project5/src/doc.txt","a+");
...
fclose(f);
fclose(f1);
remove("/home/amir07/Projects/project5/src/hotel.txt");
rename("/home/amir07/Projects/project5/src/doc.txt","/home/amir07/Projects/project5/src/hotel.txt");
}
...
int test=-1;
f=fopen("/home/amir07/Projects/project5/src/hotel.txt","r");
f1=fopen("/home/amir07/Projects/project5/src/modif.txt","a+");
...
fclose(f1);
remove("/home/amir07/Projects/project5/src/hotel.txt");
rename("/home/amir07/Projects/project5/src/modif.txt","/home/amir07/Projects/project5/src/hotel.txt");
}
