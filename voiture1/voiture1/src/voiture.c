...
void ajouter_voiture(Voiture p)
{
 ...
 FILE *f;
 f=fopen("/home/khalil/Desktop/voiture1/voiture1/src/voiture.txt","a+");
 if(f!=NULL)
 {
...
if(store==NULL)
{
	...
	f=fopen("/home/khalil/Desktop/voiture1/voiture1/src/voiture.txt","r");
...
f=fopen("/home/khalil/Desktop/voiture1/voiture1/src/voiture.txt","r");
tmp=fopen("/home/khalil/Desktop/voiture1/voiture1/src/tmp.txt","w");
if(f!=NULL){
    if(tmp!=NULL){
...
fclose(f);
if (r){
remove("/home/khalil/Desktop/voiture1/voiture1/src/voiture.txt");
rename("/home/khalil/Desktop/voiture1/voiture1/src/tmp.txt","/home/khalil/Desktop/voiture1/voiture1/src/voiture.txt");
}
}
...
Voiture p ;
    ...
    FILE *f_mod;
    FILE *f_mod1;
f_mod=fopen("/home/khalil/Desktop/voiture1/voiture1/src/voiture.txt","r");
f_mod1=fopen("/home/khalil/Desktop/voiture1/voiture1/src/mod.txt","w");
if(f_mod!=NULL){
    if(f_mod1!=NULL){
...
fclose(f_mod);
remove("/home/khalil/Desktop/voiture1/voiture1/src/voiture.txt");
rename("/home/khalil/Desktop/voiture1/voiture1/src/mod.txt","/home/khalil/Desktop/voiture1/voiture1/src/voiture.txt");
}
