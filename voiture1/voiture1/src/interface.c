...
create_ajouter_une_voiture (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed2), comboboxkhalil, 153, 64);
  gtk_widget_set_size_request (comboboxkhalil, 199, 38);
  ...
  gtk_combo_box_append_text (GTK_COMBO_BOX (comboboxkhalil), _("kia"));
...
create_modifier_voiture (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed4), combobox2khalil, 175, 64);
  gtk_widget_set_size_request (combobox2khalil, 203, 38);
  ...
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox2khalil), _("kia"));
